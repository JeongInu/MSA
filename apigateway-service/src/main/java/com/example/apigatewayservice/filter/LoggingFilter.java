...
//
//            log.info("Logging Filter baseMessage: {}, {}", cfg.getBaseMessage(), request.getRemoteAddress());
//
//            if(cfg.isPreLogger()){
...
//    }
    ...
    public GatewayFilter apply(Config cfg) {
        ...
        return new OrderedGatewayFilter((exchange, chain) -> {
            ...
            log.info("Logging Filter baseMessage: baseMessage: {}, {}", cfg.getBaseMessage(), request.getRemoteAddress());
